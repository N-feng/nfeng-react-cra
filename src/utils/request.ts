...
export const baseURL = `${UMI_APP_API_URL || ''}`
...
export const AuthAxios = axios.create({ ...config, baseURL: `${baseURL}/api-admin` })
export const PublicAxios = axios.create({ ...config, baseURL: `${baseURL}/api-server`})
